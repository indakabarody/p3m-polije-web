            ...
            <div class="mb-5 card mb-xl-10">
                ...
                <div class="pt-5 border-0 card-header">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        {{-- begin::Add admin --}}
                        <button type="button" onclick="location.href='{{ route('admin.galleries.create') }}';"
                ...
                <div class="py-3 card-body">
                    ...
                    <div class="table-responsive">
                        {{-- begin::Table --}}
                        <table id="kt_galleries_table" class="table align-middle table-row-dashed fs-6 gy-5">
                            {{-- begin::Table head --}}
                            <thead>
                            ...
                            <tbody>
                                @foreach ($galleries as $gallery)
                                    <tr>
                                        ...
                                        <td>{{ $gallery->date->format('Y-m-d') }}</td>
                                        <td>
                                            @if ($gallery->is_shown == 1)
                                                Ya
                                            @else
                                                Tidak
                                            @endif
                                            ...
                                            <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px"
                                                ...
                                                <div class="px-3 menu-item">
                                                    <a href="#" class="px-3 menu-link" data-bs-toggle="modal"
                                                        ...
                                                        onclick="setDelete('{{ route('admin.galleries.destroy', $gallery->id) }}')">Hapus</a>
                                                </div>
                                                {{-- end::Menu item --}}
                                            </div>
                                            {{-- end::Menu --}}
            ...
            <div class="modal-content">
                <form id="deleteForm" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Konfirmasi Hapus Galeri</h5>
                        {{-- begin::Close --}}
