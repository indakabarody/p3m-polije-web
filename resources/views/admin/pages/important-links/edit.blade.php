        ...
        <div class=" container-xxl" id="kt_content_container">
            ...
            <div class="mb-5 card mb-xl-10">
                ...
                <div id="kt_account_profile_details" class="collapse show">
                    {{-- begin::Form --}}
                    <form class="form" action="{{ route('admin.important-links.update', $importantLink->id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="mb-6 row">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="name"
                                        ...
                                        value="{{ old('name') ?? $importantLink->name }}" />
                                    @error('name')
                            ...
                            <div class="mb-6 row">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="url" name="url"
                                        ...
                                        placeholder="Masukkan URL" value="{{ old('url') ?? $importantLink->url }}" />
                                    @error('url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-0 row">
                                {{-- begin::Label --}}
                                <label class="col-lg-4 col-form-label fw-bold fs-6">Buka di Tab Baru</label>
                                {{-- begin::Label --}}
                                {{-- begin::Label --}}
                                <div class="col-lg-8 d-flex align-items-center">
                                    <div class="form-check form-check-solid form-switch fv-row">
                                        <input class="form-check-input w-45px h-30px" type="checkbox" id="allowmarketing"
                                            ...
                                            {{ $importantLink->open_in_new_tab ? 'checked' : '' }} />
                                ...
                                <div class="col-lg-8 d-flex align-items-center">
                                    <div class="form-check form-check-solid form-switch fv-row">
                                        <input class="form-check-input w-45px h-30px" type="checkbox" id="allowmarketing"
                                            ...
                                            {{ $importantLink->is_shown ? 'checked' : '' }} />
                                        <label class="form-check-label" for="allowmarketing"></label>
                                    </div>
                                </div>
                                {{-- begin::Label --}}
