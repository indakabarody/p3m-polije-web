                ...
                <div id="kt_account_profile_details" class="collapse show">
                    ...
                    <form class="form" action="{{ route('admin.brands.store') }}" method="POST"
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="name" id="name"
                                        ...
                                        placeholder="Masukkan Nama Brand" value="{{ old('name') }}"
                            ...
                            <div class="row mb-7">
                                {{-- begin::Label --}}
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">Gambar Logo</label>
                                {{-- end::Label --}}
                                {{-- begin::Col --}}
                                <div class="col-lg-8">
                            ...
                            <div class="row mb-6">
                                {{-- begin::Label --}}
                                <label class="col-lg-4 col-form-label fw-bold fs-6">URL Brand</label>
                                {{-- end::Label --}}
                                {{-- begin::Col --}}
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="url"
                                        class="form-control form-control-lg form-control-solid @error('url') is-invalid @enderror"
                                        placeholder="Masukkan URL Brand (opsional)" value="{{ old('url') }}" />
                                    @error('url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
