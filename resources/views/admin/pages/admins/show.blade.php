                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#"
                                            class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">{{ $admin->name }}</a>
                                    </div>
                                    {{-- end::Name --}}
                                    {{-- begin::Info --}}
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-8">
                            @if ($admin->is_activated == 1)
                                <a href="#"
                                    class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3">Aktif</a>
                            @else
                                <a href="#"
                                    class="btn btn-sm btn-light-danger fw-bolder ms-2 fs-8 py-1 px-3">Nonaktif</a>
                            @endif
                        </div>
                        {{-- begin::Label --}}
                    </div>
