            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        {{-- begin::Add admin --}}
                        <button type="button" onclick="location.href='{{ route('admin.services.create') }}';"
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        {{-- begin::Table --}}
                        <table id="kt_services_table" class="table align-middle table-row-dashed fs-6 gy-5">
                            {{-- begin::Table head --}}
                            <thead>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                        ...
                                                        onclick="setDelete('{{ route('admin.services.destroy', $service->id) }}')">Hapus</a>
                                                </div>
                                                {{-- end::Menu item --}}
                                            </div>
                                            {{-- end::Menu --}}
            ...
            <div class="modal-content">
                <form id="deleteForm" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Konfirmasi Hapus Layanan</h5>
                        {{-- begin::Close --}}
                    ...
                    <div class="modal-body">
                        <p>Yakin ingin menghapus service ini?</p>
                    </div>
