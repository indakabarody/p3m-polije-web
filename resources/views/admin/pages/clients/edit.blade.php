                ...
                <div id="kt_account_profile_details" class="collapse show">
                    ...
                    <form class="form" action="{{ route('admin.clients.update', $client->id) }}" method="POST"
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                {{-- begin::Label --}}
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">Nama Klien</label>
                                {{-- end::Label --}}
                                {{-- begin::Col --}}
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="name"
                                        class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror"
                                        placeholder="Masukkan Nama Klien" value="{{ old('name') ?? $client->name }}" />
                                    @error('client')
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="slug" id="slug"
                                        ...
                                        placeholder="Masukkan Slug" value="{{ old('slug') ?? $client->slug }}" />
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true"
                                        ...
                                        @isset($client->image)
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url({{ asset('storage/admin/clients/' . $client->id . '/' . $client->image) }})">
                                            </div>
                                        @else
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url({{ asset('themes/admin/media/avatars/blank.png') }})">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="url"
                                        ...
                                        placeholder="Masukkan URL Klien (opsional)"
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <textarea name="description" rows="5"
                                        ...
                                        placeholder="Masukkan Deskripsi Singkat">{{ old('description') ?? $client->description }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-8 d-flex align-items-center">
                                    <div class="form-check form-check-solid form-switch fv-row">
                                        <input class="form-check-input w-45px h-30px" type="checkbox" id="allowmarketing"
                                            ...
                                            @if ($client->is_shown == 1) checked="checked" @endif />
