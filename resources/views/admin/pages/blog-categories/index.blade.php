            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        {{-- begin::Add admin --}}
                        <button type="button" onclick="location.href='{{ route('admin.blog-categories.create') }}';"
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        {{-- begin::Table --}}
                        <table id="kt_blog_categories_table" class="table align-middle table-row-dashed fs-6 gy-5">
                            {{-- begin::Table head --}}
                            <thead>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                        ...
                                                        onclick="setDelete('{{ route('admin.blog-categories.destroy', $blogCategory->id) }}')">Hapus</a>
                                                </div>
                                                {{-- end::Menu item --}}
                                            </div>
                                            {{-- end::Menu --}}
...
@section('page_scripts')
    ...
    <script>
        $("#kt_blog_categories_table").DataTable({
            "language": {
