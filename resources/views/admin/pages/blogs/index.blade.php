            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        {{-- begin::Add admin --}}
                        <button type="button" onclick="location.href='{{ route('admin.blogs.create') }}';"
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        {{-- begin::Table --}}
                        <table id="kt_blogs_table" class="table align-middle table-row-dashed fs-6 gy-5">
                            {{-- begin::Table head --}}
                            <thead>
                                ...
                                @foreach ($blogs as $blog)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($blog->is_shown == 1)
                                                <span
                                                    class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Ya</span>
                                            @else
                                                <span
                                                    class="badge badge-light-danger fw-bolder fs-8 px-2 py-1 ms-2">Tidak</span>
                                            @endif
                                        </td>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                @if ($blog->is_shown == 1)
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('blogs.show', $blog->slug) }}" target="_blank"
                                                            class="menu-link px-3">Lihat Postingan</a>
                                                    </div>
                                                    {{-- begin::Menu item --}}
                                                @endif
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                        ...
                                                        onclick="setDelete('{{ route('admin.blogs.destroy', $blog->id) }}')">Hapus</a>
                                                </div>
                                                {{-- end::Menu item --}}
                                            </div>
                                            {{-- end::Menu --}}
            ...
            <div class="modal-content">
                <form id="deleteForm" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Konfirmasi Hapus Blog</h5>
                        {{-- begin::Close --}}
